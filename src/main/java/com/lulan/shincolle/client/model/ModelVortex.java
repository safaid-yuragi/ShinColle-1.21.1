...
public class ModelVortex<T extends Entity> extends ShipModel<T>
{

	public ModelPart Vortex;
	...
	public static LayerDefinition createBodyLayer()
	{
		...
		PartDefinition partdef0 = partdefinition.addOrReplaceChild("Vortex", CubeListBuilder.create().addBox(-64.0F, -64.0F, 0.0F, 128.0F, 128.0F, 0.0F), PartPose.offset(0.0F, 0.0F, 0.0F));
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int color)
	{
		...
		glowLight = true;
    	this.Vortex.render(poseStack, vertexConsumer, glowLight ? LightTexture.FULL_BRIGHT : packedLight, packedOverlay);
