...
public class ModelSubmKa<T extends Entity> extends ShipModelBaseAdv<T>
{
	...
	public ModelPart EquipC02a;
	public ModelPart EquipC02b;
	...
	public static LayerDefinition createBodyLayer()
	{
		...
		PartDefinition partdef1 = partdef0.addOrReplaceChild("Head", CubeListBuilder.create().addBox(-7.0F, -14.5F, -6.5F, 14.0F, 14.0F, 13.0F), PartPose.offset(0.0F, -11.8F, -0.5F));
		PartDefinition partdef2 = partdef1.addOrReplaceChild("Hair", CubeListBuilder.create().addBox(-8.0F, -8.0F, -7.4F, 16.0F, 12.0F, 8.0F), PartPose.offset(0.0F, -7.5F, 0.4F));
		PartDefinition partdef3 = partdef2.addOrReplaceChild("HairL01", CubeListBuilder.create().addBox(-2.5F, 0.0F, 0.0F, 5.0F, 9.0F, 2.0F), PartPose.offsetAndRotation(-4.9F, 8.0F, -7.2F, -0.17453292519943295F, 0.13962634015954636F, -0.05235987755982988F));
		PartDefinition partdef4 = partdef3.addOrReplaceChild("HairL02", CubeListBuilder.create().addBox(-2.5F, 0.0F, 0.0F, 5.0F, 12.0F, 2.0F), PartPose.offsetAndRotation(-0.3F, 7.5F, 0.1F, 0.3141592653589793F, 0.17453292519943295F, 0.17453292519943295F));
		PartDefinition partdef5 = partdef2.addOrReplaceChild("Ahoke", CubeListBuilder.create().addBox(0.0F, -5.0F, -10.5F, 0.0F, 11.0F, 11.0F), PartPose.offsetAndRotation(-1.0F, -7.0F, -5.5F, 0.2617993877991494F, 0.6981317007977318F, 0.0F));
		PartDefinition partdef6 = partdef2.addOrReplaceChild("HairU01", CubeListBuilder.create().mirror().addBox(-8.5F, 0.0F, 0.0F, 17.0F, 15.0F, 7.0F), PartPose.offset(0.0F, -6.0F, -7.7F));
		PartDefinition partdef7 = partdef2.addOrReplaceChild("HairR01", CubeListBuilder.create().mirror().addBox(-1.0F, 0.0F, 0.0F, 2.0F, 11.0F, 5.0F), PartPose.offsetAndRotation(5.9F, 7.7F, -7.5F, -0.17453292519943295F, 0.4363323129985824F, 0.13962634015954636F));
		PartDefinition partdef8 = partdef7.addOrReplaceChild("HairR02", CubeListBuilder.create().mirror().addBox(-1.0F, 0.0F, 0.0F, 2.0F, 12.0F, 5.0F), PartPose.offsetAndRotation(0.3F, 10.0F, 0.0F, 0.24434609527920614F, 0.08726646259971647F, -0.13962634015954636F));
		PartDefinition partdef9 = partdef1.addOrReplaceChild("EquipHead01", CubeListBuilder.create().addBox(-3.0F, -3.0F, 0.0F, 6.0F, 6.0F, 3.0F), PartPose.offsetAndRotation(0.0F, -1.0F, -8.0F, 0.2617993877991494F, 0.0F, 0.0F));
		PartDefinition partdef10 = partdef9.addOrReplaceChild("EquipHead03", CubeListBuilder.create().addBox(0.0F, -1.0F, -1.0F, 8.0F, 2.0F, 2.0F), PartPose.offsetAndRotation(2.0F, 0.5F, -1.0F, 0.0F, -0.08726646259971647F, 0.0F));
		PartDefinition partdef11 = partdef10.addOrReplaceChild("EquipHead04", CubeListBuilder.create().addBox(-1.0F, -1.0F, 0.0F, 2.0F, 2.0F, 15.0F), PartPose.offsetAndRotation(7.0F, 0.0F, -1.0F, -0.17453292519943295F, 0.08726646259971647F, 0.0F));
		PartDefinition partdef12 = partdef11.addOrReplaceChild("EquipHead05", CubeListBuilder.create().addBox(-1.0F, 0.0F, -1.0F, 2.0F, 9.0F, 2.0F), PartPose.offsetAndRotation(0.0F, -0.4F, 14.0F, 0.0F, 0.0F, 0.5918411493512771F));
		PartDefinition partdef13 = partdef9.addOrReplaceChild("EquipHead02", CubeListBuilder.create().addBox(-2.0F, -2.0F, 0.0F, 4.0F, 4.0F, 3.0F), PartPose.offset(0.0F, 0.5F, -3.0F));
		PartDefinition partdef14 = partdef1.addOrReplaceChild("HairMain", CubeListBuilder.create().addBox(-7.5F, 0.0F, 0.0F, 15.0F, 11.0F, 10.0F), PartPose.offset(0.0F, -14.8F, -3.0F));
		PartDefinition partdef15 = partdef14.addOrReplaceChild("Hair01", CubeListBuilder.create().addBox(-7.5F, 0.0F, 0.0F, 15.0F, 16.0F, 9.0F), PartPose.offsetAndRotation(0.0F, 8.0F, 1.1F, 0.20943951023931953F, 0.0F, 0.0F));
		PartDefinition partdef16 = partdef15.addOrReplaceChild("Hair02", CubeListBuilder.create().addBox(-8.0F, 0.0F, -5.0F, 16.0F, 16.0F, 8.0F), PartPose.offsetAndRotation(0.0F, 13.5F, 5.5F, -0.08726646259971647F, 0.0F, 0.0F));
		PartDefinition partdef17 = partdef16.addOrReplaceChild("Hair03", CubeListBuilder.create().addBox(-8.0F, 0.0F, -4.5F, 16.0F, 15.0F, 7.0F), PartPose.offsetAndRotation(0.0F, 12.5F, 0.0F, -0.13962634015954636F, 0.0F, 0.0F));
		PartDefinition partdef18 = partdef0.addOrReplaceChild("BoobR", CubeListBuilder.create().addBox(-3.0F, 0.0F, 0.0F, 6.0F, 5.0F, 5.0F), PartPose.offsetAndRotation(-3.2F, -8.6F, -3.9F, -0.6981317007977318F, 0.08726646259971647F, 0.06981317007977318F));
		PartDefinition partdef19 = partdef0.addOrReplaceChild("BodyMain2", CubeListBuilder.create().addBox(-6.5F, -11.0F, -4.0F, 13.0F, 15.0F, 7.0F), PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition partdef20 = partdef0.addOrReplaceChild("ArmLeft01", CubeListBuilder.create().mirror().addBox(-2.0F, -1.0F, -2.5F, 5.0F, 11.0F, 5.0F), PartPose.offsetAndRotation(7.8F, -9.7F, -0.7F, 0.20943951023931953F, 0.0F, -0.3141592653589793F));
		PartDefinition partdef21 = partdef20.addOrReplaceChild("ArmLeft02", CubeListBuilder.create().mirror().addBox(-5.0F, 0.0F, -5.0F, 5.0F, 11.0F, 5.0F), PartPose.offset(3.0F, 10.0F, 2.5F));
		PartDefinition partdef22 = partdef0.addOrReplaceChild("Butt2", CubeListBuilder.create().addBox(-7.5F, 0.0F, -7.0F, 15.0F, 7.0F, 8.0F), PartPose.offsetAndRotation(0.0F, 2.5F, 2.8F, 0.20943951023931953F, 0.0F, 0.0F));
		PartDefinition partdef23 = partdef0.addOrReplaceChild("BoobL2", CubeListBuilder.create().mirror().addBox(-3.0F, 0.0F, 0.0F, 6.0F, 5.0F, 5.0F), PartPose.offsetAndRotation(2.44F, -8.6F, -3.9F, -0.6981317007977318F, -0.08726646259971647F, -0.06981317007977318F));
		...
		PartDefinition partdef25 = partdef0.addOrReplaceChild("EquipBase", CubeListBuilder.create().addBox(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F), PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition partdef26 = partdef25.addOrReplaceChild("EquipC01", CubeListBuilder.create().addBox(-6.0F, 0.0F, 0.0F, 12.0F, 10.0F, 4.0F), PartPose.offset(0.0F, -9.0F, 3.0F));
		PartDefinition partdef27 = partdef26.addOrReplaceChild("EquipC02", CubeListBuilder.create().addBox(-3.5F, -3.5F, 0.0F, 7.0F, 7.0F, 10.0F), PartPose.offsetAndRotation(0.0F, 5.0F, 3.0F, -0.08726646259971647F, 0.0F, 0.0F));
		PartDefinition partdef28 = partdef27.addOrReplaceChild("EquipC02b", CubeListBuilder.create().addBox(0.0F, 0.0F, 0.0F, 9.0F, 3.0F, 3.0F), PartPose.offset(3.0F, -2.0F, 1.0F));
		PartDefinition partdef29 = partdef27.addOrReplaceChild("EquipC02a", CubeListBuilder.create().addBox(-1.0F, -11.0F, -1.0F, 2.0F, 11.0F, 2.0F), PartPose.offset(0.0F, -3.0F, 8.0F));
		PartDefinition partdef30 = partdef0.addOrReplaceChild("Butt1", CubeListBuilder.create().addBox(-7.5F, 0.0F, -7.0F, 15.0F, 7.0F, 8.0F), PartPose.offsetAndRotation(0.0F, 2.5F, 2.8F, 0.20943951023931953F, 0.0F, 0.0F));
		PartDefinition partdef31 = partdef0.addOrReplaceChild("Butt", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 2.5F, 2.8F, 0.20943951023931953F, 0.0F, 0.0F));
		PartDefinition partdef32 = partdef31.addOrReplaceChild("LegLeft01", CubeListBuilder.create().mirror().addBox(-3.0F, 0.0F, -3.0F, 6.0F, 12.0F, 6.0F), PartPose.offsetAndRotation(4.4F, 6.5F, -4.0F, -0.15707963267948966F, 0.0F, 0.10471975511965977F));
		PartDefinition partdef33 = partdef32.addOrReplaceChild("LegLeft02", CubeListBuilder.create().mirror().addBox(0.0F, 0.0F, 0.0F, 6.0F, 13.0F, 6.0F), PartPose.offset(-3.0F, 12.0F, -3.0F));
		PartDefinition partdef34 = partdef31.addOrReplaceChild("LegRight01", CubeListBuilder.create().addBox(-3.0F, 0.0F, -3.0F, 6.0F, 12.0F, 6.0F), PartPose.offsetAndRotation(-4.4F, 6.5F, -4.0F, -0.03490658503988659F, 0.0F, -0.10471975511965977F));
		PartDefinition partdef35 = partdef34.addOrReplaceChild("LegRight02", CubeListBuilder.create().addBox(-6.0F, 0.0F, 0.0F, 6.0F, 13.0F, 6.0F), PartPose.offset(3.0F, 12.0F, -3.0F));
		PartDefinition partdef36 = partdef0.addOrReplaceChild("BoobR2", CubeListBuilder.create().addBox(-3.0F, 0.0F, 0.0F, 6.0F, 5.0F, 5.0F), PartPose.offsetAndRotation(-2.44F, -8.6F, -3.9F, -0.6981317007977318F, 0.08726646259971647F, 0.06981317007977318F));
		PartDefinition partdef37 = partdef0.addOrReplaceChild("ArmRight01", CubeListBuilder.create().addBox(-3.0F, -1.0F, -2.5F, 5.0F, 11.0F, 5.0F), PartPose.offsetAndRotation(-7.8F, -9.7F, -0.7F, 0.0F, 0.0F, 0.20943951023931953F));
		PartDefinition partdef38 = partdef37.addOrReplaceChild("ArmRight02", CubeListBuilder.create().addBox(0.0F, 0.0F, -5.0F, 5.0F, 11.0F, 5.0F), PartPose.offset(-3.0F, 10.0F, 2.5F));
		PartDefinition partdef39 = partdef0.addOrReplaceChild("BoobL", CubeListBuilder.create().mirror().addBox(-3.0F, 0.0F, 0.0F, 6.0F, 5.0F, 5.0F), PartPose.offsetAndRotation(3.2F, -8.6F, -3.9F, -0.6981317007977318F, -0.08726646259971647F, -0.06981317007977318F));
		PartDefinition partdef40 = partdefinition.addOrReplaceChild("GlowBodyMain", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -11.0F, -3.0F, -0.10471975511965977F, 0.0F, 0.0F));
		PartDefinition partdef41 = partdef40.addOrReplaceChild("GlowHead", CubeListBuilder.create(), PartPose.offset(0.0F, -11.8F, -0.5F));
		PartDefinition partdef42 = partdef41.addOrReplaceChild("Face0", CubeListBuilder.create().addBox(-7.0F, 0.0F, -0.5F, 14.0F, 12.0F, 1.0F), PartPose.offset(0.0F, -12.2F, -6.1F));
		PartDefinition partdef43 = partdef41.addOrReplaceChild("Face1", CubeListBuilder.create().addBox(-7.0F, 0.0F, -0.5F, 14.0F, 12.0F, 1.0F), PartPose.offset(0.0F, -12.2F, -6.1F));
		PartDefinition partdef44 = partdef41.addOrReplaceChild("Face2", CubeListBuilder.create().addBox(-7.0F, 0.0F, -0.5F, 14.0F, 12.0F, 1.0F), PartPose.offset(0.0F, -12.2F, -6.1F));
		PartDefinition partdef45 = partdef41.addOrReplaceChild("Face3", CubeListBuilder.create().addBox(-7.0F, 0.0F, -0.5F, 14.0F, 12.0F, 1.0F), PartPose.offset(0.0F, -12.2F, -6.1F));
		PartDefinition partdef46 = partdef41.addOrReplaceChild("Face4", CubeListBuilder.create().addBox(-7.0F, 0.0F, -0.5F, 14.0F, 12.0F, 1.0F), PartPose.offset(0.0F, -12.2F, -6.1F));
		PartDefinition partdef47 = partdef41.addOrReplaceChild("Mouth0", CubeListBuilder.create().addBox(-3.0F, 0.0F, -0.5F, 6.0F, 4.0F, 1.0F), PartPose.offset(0.0F, -4.2F, -6.2F));
		PartDefinition partdef48 = partdef41.addOrReplaceChild("Mouth1", CubeListBuilder.create().addBox(-3.0F, 0.0F, -0.5F, 6.0F, 4.0F, 1.0F), PartPose.offset(0.0F, -4.2F, -6.2F));
		PartDefinition partdef49 = partdef41.addOrReplaceChild("Mouth2", CubeListBuilder.create().addBox(-3.0F, 0.0F, -0.5F, 6.0F, 4.0F, 1.0F), PartPose.offset(0.0F, -4.2F, -6.2F));
		PartDefinition partdef50 = partdef41.addOrReplaceChild("Flush0", CubeListBuilder.create().addBox(-1.0F, 0.0F, -0.5F, 2.0F, 1.0F, 0.0F), PartPose.offset(-6.0F, -3.0F, -6.9F));
		PartDefinition partdef51 = partdef41.addOrReplaceChild("Flush1", CubeListBuilder.create().addBox(-1.0F, 0.0F, -0.5F, 2.0F, 1.0F, 0.0F), PartPose.offset(6.0F, -3.0F, -6.9F));
		PartDefinition partdef52 = partdef40.addOrReplaceChild("GlowArmLeft01", CubeListBuilder.create(), PartPose.offsetAndRotation(7.8F, -9.7F, -0.7F, 0.20943951023931953F, 0.0F, -0.3141592653589793F));
		PartDefinition partdef53 = partdef52.addOrReplaceChild("GlowArmLeft02", CubeListBuilder.create(), PartPose.offset(3.0F, 10.0F, 2.5F));
		PartDefinition partdef54 = partdef53.addOrReplaceChild("EquipT01a", CubeListBuilder.create().addBox(-2.0F, -3.0F, -5.0F, 4.0F, 6.0F, 10.0F), PartPose.offset(-6.5F, 6.5F, -1.0F));
		PartDefinition partdef55 = partdef54.addOrReplaceChild("EquipT01b", CubeListBuilder.create().addBox(-2.5F, -3.5F, 0.0F, 5.0F, 7.0F, 8.0F), PartPose.offset(0.0F, 0.0F, -12.9F));
	...
	public ModelSubmKa(ModelPart root)
	{
		...
		this.EquipHead03 = root.getChild("BodyMain").getChild("Head").getChild("EquipHead01").getChild("EquipHead03");
		...
		this.EquipHead05 = root.getChild("BodyMain").getChild("Head").getChild("EquipHead01").getChild("EquipHead03").getChild("EquipHead04").getChild("EquipHead05");
		this.LegLeft02 = root.getChild("BodyMain").getChild("Butt").getChild("LegLeft01").getChild("LegLeft02");
		this.EquipHead01 = root.getChild("BodyMain").getChild("Head").getChild("EquipHead01");
		...
		this.EquipC02b = root.getChild("BodyMain").getChild("EquipBase").getChild("EquipC01").getChild("EquipC02").getChild("EquipC02b");
		...
		this.EquipHead02 = root.getChild("BodyMain").getChild("Head").getChild("EquipHead01").getChild("EquipHead02");
		this.EquipC02a = root.getChild("BodyMain").getChild("EquipBase").getChild("EquipC01").getChild("EquipC02").getChild("EquipC02a");
		this.BoobR2 = root.getChild("BodyMain").getChild("BoobR2");
		this.EquipHead04 = root.getChild("BodyMain").getChild("Head").getChild("EquipHead01").getChild("EquipHead03").getChild("EquipHead04");
...
this.animTransX += (0F); this.animTransY += (0.05F); this.animTransZ += (0F);
	    ...
	    {  //騎乘動作  	
	    	...
	    	{
this.animTransX += (0F); this.animTransY += (angleX * 0.05F + 0.18F); this.animTransZ += (0F);
			    //body
		    	this.Head.xRot -= 0.8F;
