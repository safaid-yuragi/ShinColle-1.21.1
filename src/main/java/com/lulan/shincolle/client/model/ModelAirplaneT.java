...
public class ModelAirplaneT<T extends Entity> extends ShipModel<T>
{
	...
	public static LayerDefinition createBodyLayer()
	{
		...
		PartDefinition partdef1 = partdef0.addOrReplaceChild("Wing02", CubeListBuilder.create().addBox(-13.0F, 0.0F, 0.0F, 13.0F, 1.0F, 5.0F), PartPose.offsetAndRotation(-2.0F, -0.4F, -2.5F, 0.0F, 0.0F, 0.06981317007977318F));
		PartDefinition partdef2 = partdef0.addOrReplaceChild("Tail01", CubeListBuilder.create().addBox(-2.0F, 0.0F, 0.0F, 4.0F, 3.0F, 4.0F), PartPose.offset(0.0F, -2.8F, 5.0F));
		PartDefinition partdef3 = partdef2.addOrReplaceChild("Tail02", CubeListBuilder.create().addBox(-1.5F, 0.0F, 0.0F, 3.0F, 2.0F, 6.0F), PartPose.offset(0.0F, 0.1F, 4.0F));
		PartDefinition partdef4 = partdef3.addOrReplaceChild("Tail04", CubeListBuilder.create().addBox(-6.5F, 0.0F, 0.0F, 13.0F, 1.0F, 3.0F), PartPose.offset(0.0F, 0.2F, 2.0F));
		PartDefinition partdef5 = partdef3.addOrReplaceChild("Tail03", CubeListBuilder.create().addBox(-0.5F, 0.0F, 0.0F, 1.0F, 4.0F, 3.0F), PartPose.offsetAndRotation(0.0F, -2.2F, 4.5F, -1.0471975511965976F, 0.0F, 0.0F));
		PartDefinition partdef6 = partdef0.addOrReplaceChild("Propeller", CubeListBuilder.create().addBox(-3.0F, -3.0F, 0.0F, 6.0F, 6.0F, 0.0F), PartPose.offset(0.0F, -1.0F, -6.5F));
		PartDefinition partdef7 = partdef0.addOrReplaceChild("Prop02", CubeListBuilder.create().addBox(-0.5F, -0.5F, 0.0F, 1.0F, 1.0F, 2.0F), PartPose.offset(0.0F, -1.0F, -7.1F));
		PartDefinition partdef8 = partdef0.addOrReplaceChild("Wing01", CubeListBuilder.create().mirror().addBox(0.0F, 0.0F, 0.0F, 13.0F, 1.0F, 5.0F), PartPose.offsetAndRotation(2.0F, -0.4F, -2.5F, 0.0F, 0.0F, -0.06981317007977318F));
		PartDefinition partdef9 = partdef0.addOrReplaceChild("Tank", CubeListBuilder.create().addBox(-1.0F, 0.0F, 0.0F, 2.0F, 2.0F, 14.0F), PartPose.offsetAndRotation(0.0F, 1.5F, -5.5F, 0.03490658503988659F, 0.0F, 0.0F));
		...
		PartDefinition partdef11 = partdef10.addOrReplaceChild("BodyU", CubeListBuilder.create().addBox(-1.5F, 0.0F, 0.0F, 3.0F, 2.0F, 6.0F), PartPose.offsetAndRotation(0.0F, -4.9F, -1.8F, -0.3141592653589793F, 0.0F, 0.0F));
