...
/**
 * port of legacy EntitySubmHime.
 * AI/attack goals and skill behaviour are added in Phase 4.
 */
public class EntitySubmHime extends BasicEntityShipSmall
{


    public EntitySubmHime(EntityType<? extends BasicEntityShip> type, Level level)
    {
        super(type, level);
