...
//        put(ID.ShipIconType.,    new int[] {99, 29});  //empty for now
        put(ID.ShipIconType.DEMON,                new int[] {99, 58});
//        put(ID.ShipIconType.,    new int[] {99, 87});  //empty for now
    }});
    ...
    {{
        ...
        put(ID.Icon.Grudge,     new ItemStack(ModItems.GRUDGE.get()));
        put(ID.Icon.GrudgeB,    new ItemStack(ModBlocks.BLOCK_GRUDGE.get()));
        put(ID.Icon.GrudgeBH,   new ItemStack(ModBlocks.BLOCK_GRUDGE_HEAVY.get()));
        put(ID.Icon.AbyssIG,    new ItemStack(ModItems.ABYSS_METAL.get()));
        put(ID.Icon.AbyssB,     new ItemStack(ModBlocks.BLOCK_ABYSSIUM.get()));
        put(ID.Icon.PolymIG,    new ItemStack(ModItems.ABYSS_METAL_1.get()));
        put(ID.Icon.PolymOre,   new ItemStack(ModBlocks.BLOCK_POLYMETAL_ORE.get()));
        put(ID.Icon.PolymB,     new ItemStack(ModBlocks.BLOCK_POLYMETAL.get()));
        put(ID.Icon.PolymBG,    new ItemStack(ModBlocks.BLOCK_POLYMETAL_GRAVEL.get()));
        put(ID.Icon.Gunpowder,  new ItemStack(Items.GUNPOWDER));
        put(ID.Icon.Blazepowder,new ItemStack(Items.BLAZE_POWDER));
        put(ID.Icon.AmmoL,      new ItemStack(ModItems.AMMO.get()));
        put(ID.Icon.AmmoLC,     new ItemStack(ModItems.AMMO_1.get()));
        put(ID.Icon.AmmoH,      new ItemStack(ModItems.AMMO_2.get()));
        put(ID.Icon.AmmoHC,     new ItemStack(ModItems.AMMO_3.get()));
        put(ID.Icon.RpBucket,   new ItemStack(ModItems.BUCKET_REPAIR.get()));
        put(ID.Icon.LaBucket,   new ItemStack(Items.LAVA_BUCKET));
        put(ID.Icon.NStar,      new ItemStack(Items.NETHER_STAR));
        put(ID.Icon.Ring,       new ItemStack(ModItems.MARRIAGE_RING.get()));
        put(ID.Icon.Paper,      new ItemStack(Items.PAPER));
        put(ID.Icon.OwnPaper,   new ItemStack(ModItems.OWNER_PAPER.get()));
        put(ID.Icon.Stick,      new ItemStack(Items.STICK));
        put(ID.Icon.KHammer,    new ItemStack(ModItems.KAITAI_HAMMER.get()));
        put(ID.Icon.ModTool,    new ItemStack(ModItems.MODERN_KIT.get()));
        put(ID.Icon.SpawnEgg0,  new ItemStack(ModItems.SHIP_SPAWN_EGG.get()));
        put(ID.Icon.SpawnEgg1,  new ItemStack(ModItems.SHIP_SPAWN_EGG.get()));
        put(ID.Icon.SpawnEgg2,  new ItemStack(ModItems.SHIP_SPAWN_EGG.get()));
        put(ID.Icon.InstantMat, new ItemStack(ModItems.INSTANT_CON_MAT.get()));
        put(ID.Icon.DiamondB,   new ItemStack(Blocks.DIAMOND_BLOCK));
        put(ID.Icon.RpGod,      new ItemStack(ModItems.REPAIR_GODDESS.get()));
        put(ID.Icon.Pointer,    new ItemStack(ModItems.POINTER_ITEM.get()));
        put(ID.Icon.ModelZF,    new ItemStack(ModItems.TOY_AIRPLANE.get()));
        put(ID.Icon.Desk,       new ItemStack(ModBlocks.BLOCK_DESK.get()));
        put(ID.Icon.DeskBook,   new ItemStack(ModItems.DESK_ITEM_BOOK.get()));
        put(ID.Icon.DeskRadar,  new ItemStack(ModItems.DESK_ITEM_RADAR.get()));
        ...
        put(ID.Icon.WoolB,      new ItemStack(Blocks.WHITE_WOOL));
        put(ID.Icon.SmallSY,    new ItemStack(ModBlocks.BLOCK_SMALL_SHIPYARD.get()));
        put(ID.Icon.Wrench,     new ItemStack(ModItems.TARGET_WRENCH.get()));
        put(ID.Icon.VolCore,    new ItemStack(ModBlocks.BLOCK_VOL_CORE.get()));
        put(ID.Icon.VolBlock,   new ItemStack(ModBlocks.BLOCK_VOL_BLOCK.get()));
        put(ID.Icon.Frame,      new ItemStack(ModBlocks.BLOCK_FRAME.get()));
        put(ID.Icon.Waypoint,   new ItemStack(ModBlocks.BLOCK_WAYPOINT.get()));
        put(ID.Icon.Crane,      new ItemStack(ModBlocks.BLOCK_CRANE.get()));
        put(ID.Icon.Piston,     new ItemStack(Blocks.PISTON));
        put(ID.Icon.TrainBook,  new ItemStack(ModItems.TRAINING_BOOK.get()));
        put(ID.Icon.MagmaB,     new ItemStack(Blocks.MAGMA_BLOCK));
        put(ID.Icon.Tank0,      new ItemStack(ModItems.SHIP_TANK.get()));
        put(ID.Icon.Tank1,      new ItemStack(ModItems.SHIP_TANK_1.get()));
        put(ID.Icon.Tank2,      new ItemStack(ModItems.SHIP_TANK_2.get()));
        put(ID.Icon.Tank3,      new ItemStack(ModItems.SHIP_TANK_3.get()));
        put(ID.Icon.Cauldron,   new ItemStack(Items.CAULDRON));
        put(ID.Icon.Lapis,      new ItemStack(Items.LAPIS_LAZULI));
        put(ID.Icon.RecipePaper,new ItemStack(ModItems.RECIPE_PAPER.get()));
        put(ID.Icon.OPTool,     new ItemStack(ModItems.OP_TOOL.get()));
        put(ID.Icon.AmmoEnchant,new ItemStack(ModItems.EQUIP_AMMO_7.get()));
        put(ID.Icon.Potions,    new ItemStack(Items.POTION));
        put(ID.Icon.GrudgeXP,   new ItemStack(ModItems.GRUDGE_1.get()));
        put(ID.Icon.GrudgeXPB,  new ItemStack(ModBlocks.BLOCK_GRUDGE_XP.get()));
