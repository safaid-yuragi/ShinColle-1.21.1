...
public class AttrsAdv extends Attrs
{
	...
	/** formation buff lookup: {@link Values#FormationAttrs} keyed by formationID * 10 + slotID */
	...
	{
		this.AttrsFormation = AttrsAdv.getFormationBuffValue(formatID, formatSlot);
	}
